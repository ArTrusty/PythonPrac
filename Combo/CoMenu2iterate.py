...
if mcFr == "yes" and bev == "yes":
    ...
    print("you bought:",many_drink, drink, "drink", many_sandW, sandW, "sandwich", many_Fr, frChoice, "fries")
    print(order)
elif mcFr == "no" and bev == "no":
    finalTotal = sandW_total + sauceCash
    print("your total comes to:", finalTotal)
    print("you bought:", many_sandW, sandW, "sandwich and no fries and no drink")
    print(order)
elif mcFr == "yes" and bev == "no":
    finalTotal = fr_Total + sandW_total + sauceCash
    print("your total comes to:", finalTotal)
    print("you bought:", many_sandW, sandW, "sandwich", many_Fr, frChoice, "fries but no drink")
    print(order)
elif mcFr == "no" and bev == "yes":
    finalTotal = drink_total + sandW_total + sauceCash
    print("your total comes to:", finalTotal)
    print("(customer receipt) you bought:", many_drink, drink, "drink", many_sandW, sandW, "sandwich but no fries")
